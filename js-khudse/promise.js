let inst = new Promise(function (resolve, reject) {
    let x = 12;
    if (x == 12) {
        resolve(x);
    } else {
...
let promises = fetch('https://api.github.com/users/iliakan');
promises.then((resp) => {
    console.log(resp.json().then((ele)=> console.log(ele)));
})
...
const message2 = importantAction("Roadside Coder", (message) => {
  console.log(message);
